    ...
    >
      <Container sx={{ position: 'relative', zIndex: 2 }}>
        ...
        <Typography variant="h6" mb={4} sx={{ color: '#fff' }}>
          Shop the latest tech — wireless, wearable, and wonderful.<br />
          Find exclusive deals on headphones, smartwatches, speakers, and more, all in one place.
        </Typography>
        <Button
          variant="contained"
          size="large"
          sx={{
            color: '#fff',
            background: 'linear-gradient(90deg, #7F00FF 0%,rgb(206, 33, 157) 100%)',
            ...
            '&:hover': {
              background: 'linear-gradient(90deg,rgb(206, 33, 157) 0%,  #7F00FF 100%)',
            },
          }}
        >
          Explore Now
